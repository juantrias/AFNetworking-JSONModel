...
#define COCOAPODS_POD_AVAILABLE_AFNetworking_JSONModel
#define COCOAPODS_VERSION_MAJOR_AFNetworking_JSONModel 0
#define COCOAPODS_VERSION_MINOR_AFNetworking_JSONModel 0
#define COCOAPODS_VERSION_PATCH_AFNetworking_JSONModel 1
