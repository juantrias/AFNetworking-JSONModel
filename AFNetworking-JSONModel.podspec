#
#  Be sure to run `pod spec lint AFNetworking-JSONModel.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Juan Trías"
  # s.authors            = { "Juan Trías" => "juan.trias@intelygenz.com" }
  # s.social_media_url   = "http://twitter.com/Juan Trías"
